...
var _require = require('../utils/int64'),
    I64 = _require.I64;
...
function ScriptNum(num, base) {
  if (!(this instanceof ScriptNum)) return new ScriptNum(num, base);

  I64.call(this, num, base);
}

(0, _setPrototypeOf2.default)(ScriptNum, I64);
(0, _setPrototypeOf2.default)(ScriptNum.prototype, I64.prototype);
