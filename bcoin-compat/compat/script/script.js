...
var _iterator19 = require('babel-runtime/core-js/symbol/iterator');

var _iterator20 = _interopRequireDefault(_iterator19);
...
Script.prototype[_iterator20.default] = function () {
  return (0, _getIterator3.default)(this.code);
};
...
Script.prototype.fromArray = function fromArray(code) {
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(code), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var op = _step.value;
...
Script.prototype.toItems = function toItems() {
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)(this.code), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var op = _step2.value;
...
Script.prototype.toString = function toString() {
  ...
  try {
    for (var _iterator4 = (0, _getIterator3.default)(this.code), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      var op = _step4.value;
...
Script.prototype.toASM = function toASM(decode) {
  ...
  try {
    for (var _iterator5 = (0, _getIterator3.default)(this.code), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      var op = _step5.value;
...
Script.prototype.compile = function compile() {
  ...
  try {
    for (var _iterator6 = (0, _getIterator3.default)(this.code), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      var op = _step6.value;
  ...
  try {
    for (var _iterator7 = (0, _getIterator3.default)(this.code), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      var _op = _step7.value;
...
Script.prototype.removeSeparators = function removeSeparators() {
  ...
  try {
    for (var _iterator8 = (0, _getIterator3.default)(this.code), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      var op = _step8.value;
  ...
  try {
    for (var _iterator9 = (0, _getIterator3.default)(this.code), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
      var _op2 = _step9.value;
      ...
      case opcodes.OP_CHECKMULTISIGVERIFY:
        {
          ...
          while (_res2 && m > 0) {
            ...
            if (_sig2.length > 0) {
              ...
              var _hash = tx.signatureHash(index, _subscript, value, _type, version);

              if (checksig(_hash, _sig2, _key)) {
                isig += 1;
                m -= 1;
              }
            }
...
Script.prototype.findAndDelete = function findAndDelete(data) {
  ...
  try {
    for (var _iterator10 = (0, _getIterator3.default)(this.code), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
  ...
  try {
    for (var _iterator11 = (0, _getIterator3.default)(this.code), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      var _op3 = _step11.value;
...
Script.prototype.isCode = function isCode() {
  ...
  try {
    for (var _iterator12 = (0, _getIterator3.default)(this.code), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
      var op = _step12.value;
...
Script.prototype.fromMultisig = function fromMultisig(m, n, keys) {
  ...
  try {
    for (var _iterator13 = (0, _getIterator3.default)(sortKeys(keys)), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
...
Script.prototype.getRedeem = function getRedeem() {
  ...
  try {
    for (var _iterator14 = (0, _getIterator3.default)(this.code), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
...
Script.prototype.isStandard = function isStandard() {
  var _getMultisig = this.getMultisig(),
      _getMultisig2 = (0, _slicedToArray3.default)(_getMultisig, 2),
      m = _getMultisig2[0],
      n = _getMultisig2[1];
...
Script.prototype.getWitnessMasthash = function getWitnessMasthash() {
  if (!this.isWitnessMasthash()) return null;
...
Script.prototype.test = function test(filter) {
  ...
  try {
    for (var _iterator15 = (0, _getIterator3.default)(this.code), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
...
Script.prototype.isPushOnly = function isPushOnly() {
  ...
  try {
    for (var _iterator16 = (0, _getIterator3.default)(this.code), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
...
Script.prototype.getSigops = function getSigops(accurate) {
  ...
  try {
    for (var _iterator17 = (0, _getIterator3.default)(this.code), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
...
Script.prototype.fromString = function fromString(code) {
  ...
  try {
    for (var _iterator18 = (0, _getIterator3.default)(items), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
...
Script.verifyProgram = function verifyProgram(witness, output, flags, tx, index, value) {
  ...
  if (program.version === 0) {
    if (program.data.length === 32) {
      ...
      if (!digest.sha256(witnessScript).equals(program.data)) throw new ScriptError('WITNESS_PROGRAM_MISMATCH');
...
Script.verifyMast = function verifyMast(program, stack, output, flags, tx, index, value) {
  ...
  for (var _j = 0; _j < depth; _j++) {
    path.push(pathdata.slice(_j * 32, _j * 32 + 32));
  }var posdata = stack.get(-3);
  ...
  if (posdata.length > 0) {
    ...
    for (var _j2 = 0; _j2 < posdata.length; _j2++) {
      pos |= posdata[_j2] << 8 * _j2;
  ...
  for (var _j3 = 0; _j3 < subscripts; _j3++) {
    var script = stack.get(-(4 + _j3));
    if (version === 0) {
      if (scripts.offset + script.length > consensus.MAX_SCRIPT_SIZE) throw new ScriptError('SCRIPT_SIZE');
    }
  ...
  if (version === 0) {
    ...
    for (var _j4 = 0; _j4 < stack.length; _j4++) {
      if (stack.get(_j4).length > consensus.MAX_SCRIPT_PUSH) throw new ScriptError('PUSH_SIZE');
    }
