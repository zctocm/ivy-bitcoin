...
function EnvPacket(env) {
  Packet.call(this);
  this.env = env || {};
  this.json = (0, _stringify2.default)(this.env);
}

(0, _setPrototypeOf2.default)(EnvPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(EventPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(LogPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ErrorPacket.prototype, Packet.prototype);
...
ErrorPacket.prototype.getSize = function getSize() {
  ...
  switch ((0, _typeof3.default)(err.code)) {
    case 'number':
      size += 1;
      size += 4;
      break;
...
(0, _setPrototypeOf2.default)(ErrorResultPacket.prototype, ErrorPacket.prototype);
...
(0, _setPrototypeOf2.default)(CheckPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(CheckResultPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(SignPacket.prototype, Packet.prototype);
...
SignPacket.prototype.getSize = function getSize() {
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(this.rings), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
SignPacket.prototype.toWriter = function toWriter(bw) {
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)(this.rings), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
(0, _setPrototypeOf2.default)(SignResultPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(CheckInputPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(CheckInputResultPacket.prototype, CheckResultPacket.prototype);
...
(0, _setPrototypeOf2.default)(SignInputPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(SignInputResultPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ECVerifyPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ECVerifyResultPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ECSignPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ECSignResultPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(MinePacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(MineResultPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ScryptPacket.prototype, Packet.prototype);
...
(0, _setPrototypeOf2.default)(ScryptResultPacket.prototype, Packet.prototype);
