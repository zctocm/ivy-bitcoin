...
Address.prototype.equals = function equals(addr) {
  ...
  return this.network === addr.network && this.type === addr.type && this.version === addr.version && this.hash.equals(addr.hash);
};
...
Address.prototype.fromWitness = function fromWitness(witness) {
  var _witness$getPubkeyhas = witness.getPubkeyhashInput(),
      _witness$getPubkeyhas2 = (0, _slicedToArray3.default)(_witness$getPubkeyhas, 2),
      pk = _witness$getPubkeyhas2[1];
...
Address.prototype.fromInputScript = function fromInputScript(script) {
  var _script$getPubkeyhash = script.getPubkeyhashInput(),
      _script$getPubkeyhash2 = (0, _slicedToArray3.default)(_script$getPubkeyhash, 2),
      pk = _script$getPubkeyhash2[1];
