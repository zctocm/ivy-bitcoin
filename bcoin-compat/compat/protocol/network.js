...
Network.prototype._init = function _init() {
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(this.deploys), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)((0, _keys2.default)(this.checkpointMap)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
Network.by = function by(value, compare, network, name) {
  ...
  try {
    for (var _iterator3 = (0, _getIterator3.default)(networks.types), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
