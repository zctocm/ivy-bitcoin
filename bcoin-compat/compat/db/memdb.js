...
MemDB.prototype.get = function get(key, options, callback) {
  ...
  if (!value) {
    var err = new Error('MEMDB_NOTFOUND: Key not found.');
    err.notFound = true;
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)(this.ops), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      switch (op.type) {
        ...
        default:
          (0, _setImmediate3.default)(function () {
            return callback(new Error('Bad op.'));
          });
          return this;
      }
    }
...
Iterator.prototype.next = function next(callback) {
  ...
  if (!this.iter) {
    (0, _setImmediate3.default)(function () {
      return callback(new Error('Cannot call next.'));
    });
    return;
  }
...
Iterator.prototype.end = function end(callback) {
  if (this.ended) {
    (0, _setImmediate3.default)(function () {
      return callback(new Error('Already ended.'));
    });
    return;
  }
