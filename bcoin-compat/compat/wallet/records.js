...
function BlockMeta(hash, height, time) {
  if (!(this instanceof BlockMeta)) return new BlockMeta(hash, height, time);
...
BlockMapRecord.prototype.fromRaw = function fromRaw(data) {
  ...
  for (var i = 0; i < count; i++) {
    ...
    var tx = TXMapRecord.fromReader(hash, br);
...
BlockMapRecord.prototype.getSize = function getSize() {
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(this.txs.values()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var tx = _step.value;
...
BlockMapRecord.prototype.toArray = function toArray() {
  ...
  try {
    for (var _iterator3 = (0, _getIterator3.default)(this.txs.values()), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      var tx = _step3.value;
...
function TXMapRecord(hash, wids) {
  this.hash = hash || encoding.NULL_HASH;
  this.wids = wids || new _set2.default();
}
...
function serializeWallets(bw, wids) {
  ...
  try {
    for (var _iterator4 = (0, _getIterator3.default)(wids), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      var wid = _step4.value;
